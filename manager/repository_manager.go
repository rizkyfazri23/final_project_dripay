...
type RepoManager interface {
	...
	PaymentTypeRepo() repository.PaymentTypeRepo
}
...
func (r *repositoryManager) PaymentTypeRepo() repository.PaymentTypeRepo {
	return repository.NewTransactionTypeRepo(r.infraManager.DbConn())
}
